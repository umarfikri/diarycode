                            ...
                            <div class="col-md-12 ml-auto mr-auto">
                                <form method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="file" name="profileimage" name="image">                                
                                    </div>       
                                    <div class="form-group">
                                        <label>Home Page Background Image</label>
                                        <input class="form-control" type="file" name="homeimage" name="image">                                
                                    </div>
                                    <div class="form-group">
                                        <label>Other Backround Image</label>
                                        <input class="form-control" type="file" name="otherimage" name="image">                                
                                    </div>                                             
